...
{
public:
	FSetPointerGraspCommand(UTouchPointer* Pointer, bool bEnableGrasp)
		: Pointer(Pointer)
...
IMPLEMENT_COMPLEX_AUTOMATION_TEST(FGrabbableComponentTickTest, "MixedRealityUtils.GrabbableComponentTick",
...
bool FGrabbableComponentTickTest::RunTest(const FString& Parameters)
{
	...
	UTouchPointer* Pointer = MixedRealityTestUtils::CreateTouchPointer(World, Center + FVector(-15, 0, 0));
