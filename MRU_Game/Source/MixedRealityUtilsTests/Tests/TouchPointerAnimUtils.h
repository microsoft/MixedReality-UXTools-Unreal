 ...
 */
UCLASS()
class MIXEDREALITYUTILSTESTS_API UTestTouchPointerTarget : public UActorComponent, public ITouchPointerTarget
{
	GENERATED_BODY()
...
namespace TouchPointerAnimUtils
{
	...
	{
		const std::vector<UTouchPointer*>& GetPointers() const { return Pointers; }
	...
	private:
		...
		std::vector<UTouchPointer*> Pointers;
