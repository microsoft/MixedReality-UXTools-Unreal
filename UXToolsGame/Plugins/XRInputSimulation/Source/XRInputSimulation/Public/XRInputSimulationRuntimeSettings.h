...
#include "XRInputSimulationRuntimeSettings.generated.h"

class UAnimInstance;
class USkeletalMesh;

USTRUCT()
struct XRINPUTSIMULATION_API FXRInputSimulationButtonSet
{
	GENERATED_BODY()

	UPROPERTY(
		EditAnywhere, Category = "Input Simulation",
...
/**
 * Settings for XRInputSimulation.
 */
UCLASS(config = EditorPerProjectUserSettings)
class XRINPUTSIMULATION_API UXRInputSimulationRuntimeSettings : public UObject
{
public:
	GENERATED_BODY()

	UXRInputSimulationRuntimeSettings(const FObjectInitializer& ObjectInitializer);

	static UXRInputSimulationRuntimeSettings* Get();
	...
	UPROPERTY(
		GlobalConfig, EditAnywhere, Category = "Input Simulation",
	...
	TMap<FName, FXRInputSimulationButtonSet> HandPoseButtonMappings;
...
private:
	static class UXRInputSimulationRuntimeSettings* XRInputSimSettingsSingleton;
};
