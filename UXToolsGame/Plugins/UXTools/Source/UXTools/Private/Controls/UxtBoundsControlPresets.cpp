...
static FVector GetAffordancePresetLocation(EBoundsControlAffordancePreset Preset)
{
	switch (Preset)
	{
	case EBoundsControlAffordancePreset::Center:
		return FVector(0, 0, 0);

	case EBoundsControlAffordancePreset::FaceFront:
		return FVector(1, 0, 0);
	case EBoundsControlAffordancePreset::FaceBack:
		return FVector(-1, 0, 0);
	case EBoundsControlAffordancePreset::FaceRight:
		return FVector(0, 1, 0);
	case EBoundsControlAffordancePreset::FaceLeft:
		return FVector(0, -1, 0);
	case EBoundsControlAffordancePreset::FaceTop:
		return FVector(0, 0, 1);
	case EBoundsControlAffordancePreset::FaceBottom:
		return FVector(0, 0, -1);

	case EBoundsControlAffordancePreset::EdgeFrontRight:
		return FVector(1, 1, 0);
	case EBoundsControlAffordancePreset::EdgeFrontLeft:
		return FVector(1, -1, 0);
	case EBoundsControlAffordancePreset::EdgeFrontTop:
		return FVector(1, 0, 1);
	case EBoundsControlAffordancePreset::EdgeFrontBottom:
		return FVector(1, 0, -1);
	case EBoundsControlAffordancePreset::EdgeBackRight:
		return FVector(-1, 1, 0);
	case EBoundsControlAffordancePreset::EdgeBackLeft:
		return FVector(-1, -1, 0);
	case EBoundsControlAffordancePreset::EdgeBackTop:
		return FVector(-1, 0, 1);
	case EBoundsControlAffordancePreset::EdgeBackBottom:
		return FVector(-1, 0, -1);
	case EBoundsControlAffordancePreset::EdgeRightTop:
		return FVector(0, 1, 1);
	case EBoundsControlAffordancePreset::EdgeRightBottom:
		return FVector(0, 1, -1);
	case EBoundsControlAffordancePreset::EdgeLeftTop:
		return FVector(0, -1, 1);
	case EBoundsControlAffordancePreset::EdgeLeftBottom:
		return FVector(0, -1, -1);

	case EBoundsControlAffordancePreset::CornerFrontRightTop:
		return FVector(1, 1, 1);
	case EBoundsControlAffordancePreset::CornerFrontRightBottom:
		return FVector(1, 1, -1);
	case EBoundsControlAffordancePreset::CornerFrontLeftTop:
		return FVector(1, -1, 1);
	case EBoundsControlAffordancePreset::CornerFrontLeftBottom:
		return FVector(1, -1, -1);
	case EBoundsControlAffordancePreset::CornerBackRightTop:
		return FVector(-1, 1, 1);
	case EBoundsControlAffordancePreset::CornerBackRightBottom:
		return FVector(-1, 1, -1);
	case EBoundsControlAffordancePreset::CornerBackLeftTop:
		return FVector(-1, -1, 1);
	case EBoundsControlAffordancePreset::CornerBackLeftBottom:
		return FVector(-1, -1, -1);
	}
...
static EUxtBoundsControlAffordanceKind GetAffordancePresetKind(EBoundsControlAffordancePreset Preset)
{
	...
	case EBoundsControlAffordancePreset::FaceFront:
		return EUxtBoundsControlAffordanceKind::Face;
	case EBoundsControlAffordancePreset::FaceBack:
		return EUxtBoundsControlAffordanceKind::Face;
	case EBoundsControlAffordancePreset::FaceRight:
		return EUxtBoundsControlAffordanceKind::Face;
	...
	case EBoundsControlAffordancePreset::EdgeFrontRight:
		return EUxtBoundsControlAffordanceKind::Edge;
	case EBoundsControlAffordancePreset::EdgeFrontLeft:
		return EUxtBoundsControlAffordanceKind::Edge;
	case EBoundsControlAffordancePreset::EdgeFrontTop:
		return EUxtBoundsControlAffordanceKind::Edge;
	...
	case EBoundsControlAffordancePreset::CornerFrontRightTop:
		return EUxtBoundsControlAffordanceKind::Corner;
	case EBoundsControlAffordancePreset::CornerFrontRightBottom:
		return EUxtBoundsControlAffordanceKind::Corner;
	case EBoundsControlAffordancePreset::CornerFrontLeftTop:
		return EUxtBoundsControlAffordanceKind::Corner;
...
static FUxtBoundsControlAffordanceInfo MakeAffordanceFromPreset(
	EBoundsControlAffordancePreset Preset, EUxtBoundsControlAffordanceAction Action, bool uniformAction = true)
{
...
const TArray<FUxtBoundsControlAffordanceInfo>& FUxtBoundsControlPresetUtils::GetPresetAffordances(EUxtBoundsControlPreset Preset)
{
	switch (Preset)
	{
	case EUxtBoundsControlPreset::Default:
		return Preset_CornerResizeEdgeRotate;
	case EUxtBoundsControlPreset::Slate2D:
		return Preset_Slate2D;
	case EUxtBoundsControlPreset::AllResize:
		return Preset_AllResize;
	case EUxtBoundsControlPreset::AllTranslate:
		return Preset_AllTranslate;
	case EUxtBoundsControlPreset::AllScale:
		return Preset_AllScale;
	case EUxtBoundsControlPreset::AllRotate:
		return Preset_AllRotate;
	}
	return Preset_Empty;
}
