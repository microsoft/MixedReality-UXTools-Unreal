...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Button Visuals Brush")
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Button Audio Brush")
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Button Brush")
