				...
				[this]
				{
					BeforeEach(
						[this]
						{
							...
							ButtonComponent->OnButtonPressed.AddDynamic(
								ButtonEventCaptureObj, &UPressableButtonTestComponent::IncrementPressed);
							ButtonComponent->OnButtonReleased.AddDynamic(
								ButtonEventCaptureObj, &UPressableButtonTestComponent::IncrementReleased);
