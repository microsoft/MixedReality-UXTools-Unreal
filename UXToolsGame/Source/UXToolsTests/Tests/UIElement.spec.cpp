...
void UIElementSpec::Define()
{
	...
	It("children should retain state through transitions",
	   [this]
	   {
	...
	It("should update state after re-parent",
	   [this]
	   {
	...
	It("should trigger events on all elements",
	   [this]
	   {
	...
	It("should not trigger events on hidden children",
	   [this]
	   {
		   UUIElementTestComponent* RootEvents = AddEventCaptureComponent(RootUIElement);
		   UUIElementTestComponent* ChildEvents = AddEventCaptureComponent(ChildUIElement);
