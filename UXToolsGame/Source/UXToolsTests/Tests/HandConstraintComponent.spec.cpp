		...
		[this]
		{
			BeforeEach(
				[this]()
				{
					...
					HandConstraint->OnConstraintActivated.AddDynamic(
						HandConstraintListener, &UHandConstraintListener::OnConstraintActivated);
					HandConstraint->OnConstraintDeactivated.AddDynamic(
						HandConstraintListener, &UHandConstraintListener::OnConstraintDeactivated);
			...
			LatentIt(
				"should become inactive when hand tracking is lost",
			...
			LatentIt(
				"goal should have valid location in Hand-Rotation mode",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
					...
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::UlnarSide, FVector(68.5221f, 14.8143f, -11.3704f));
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::RadialSide, FVector(71.4779f, 25.1857f, -18.6296f));
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::AboveFingerTips, FVector(76.2985f, 18.4254f, -14.6851f));
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::BelowWrist, FVector(63.7015f, 21.5746f, -15.3149f));

					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::UlnarSide, FVector(71.4779f, 25.1857f, -18.6296f));
					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::RadialSide, FVector(68.5221f, 14.8143f, -11.3704f));
					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::AboveFingerTips, FVector(76.2985f, 18.4254f, -14.6851f));
					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::BelowWrist, FVector(63.7015f, 21.5746f, -15.3149f));

					FrameQueue.Enqueue([Done]() { Done.Execute(); });
				});

			LatentIt(
				"goal should have valid location in Look-At-Camera mode",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
					...
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::UlnarSide, FVector(67.4658f, 28.8696f, -15.0000f));
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::RadialSide, FVector(72.5342f, 11.1304f, -15.0000f));
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::AboveFingerTips, FVector(70.0000f, 20.0000f, -7.1513f));
					EnqueueGoalLocationTest(
						EControllerHand::Left, EUxtHandConstraintZone::BelowWrist, FVector(70.0000f, 20.0000f, -22.8487f));

					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::UlnarSide, FVector(72.5342f, 11.1304f, -15.0000f));
					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::RadialSide, FVector(67.4658f, 28.8696f, -15.0000f));
					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::AboveFingerTips, FVector(70.0000f, 20.0000f, -7.1513f));
					EnqueueGoalLocationTest(
						EControllerHand::Right, EUxtHandConstraintZone::BelowWrist, FVector(70.0000f, 20.0000f, -22.8487f));

					FrameQueue.Enqueue([Done]() { Done.Execute(); });
				});

			LatentIt(
				"goal should have valid rotation in Hand-Rotation mode",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
					...
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::UlnarSide, FQuat(-0.1195f, 0.6793f, -0.2946f, 0.6614f));
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::RadialSide, FQuat(-0.1195f, 0.6793f, -0.2946f, 0.6614f));
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::AboveFingerTips, FQuat(-0.1195f, 0.6793f, -0.2946f, 0.6614f));
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::BelowWrist, FQuat(-0.1195f, 0.6793f, -0.2946f, 0.6614f));

					EnqueueGoalRotationTest(
						EControllerHand::Right, EUxtHandConstraintZone::UlnarSide, FQuat(-0.1195f, 0.6793f, -0.2946f, 0.6614f));
					EnqueueGoalRotationTest(
			...
			LatentIt(
				"goal should have valid rotation in Look-At-Camera mode",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
					...
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::UlnarSide, FQuat(0.0986f, 0.0202f, 0.9747f, -0.1998f));
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::RadialSide, FQuat(0.1004f, 0.0077f, 0.9920f, -0.0757f));
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::AboveFingerTips, FQuat(0.0485f, 0.0068f, 0.9891f, -0.1385f));
					EnqueueGoalRotationTest(
						EControllerHand::Left, EUxtHandConstraintZone::BelowWrist, FQuat(0.1500f, 0.0210f, 0.9789f, -0.1371f));

					EnqueueGoalRotationTest(
						EControllerHand::Right, EUxtHandConstraintZone::UlnarSide, FQuat(0.1004f, 0.0077f, 0.9920f, -0.0757f));
					EnqueueGoalRotationTest(
						EControllerHand::Right, EUxtHandConstraintZone::RadialSide, FQuat(0.0986f, 0.0202f, 0.9747f, -0.1998f));
					EnqueueGoalRotationTest(
						EControllerHand::Right, EUxtHandConstraintZone::AboveFingerTips, FQuat(0.0485f, 0.0068f, 0.9891f, -0.1385f));
					EnqueueGoalRotationTest(
						EControllerHand::Right, EUxtHandConstraintZone::BelowWrist, FQuat(0.1500f, 0.0210f, 0.9789f, -0.1371f));

					FrameQueue.Enqueue([Done]() { Done.Execute(); });
				});

			LatentIt(
				"tracked hand should be left when hand user setting is Left",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
			...
			LatentIt(
				"tracked hand should be right when hand user setting is Right",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
			...
			LatentIt(
				"tracked hand should switch when hand user setting is Any Hand",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
			...
			LatentIt(
				"should snap actor to goal when smoothing is disabled",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
			...
			LatentIt(
				"should move actor towards goal when smoothing is enabled",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
						...
						[this, Done]()
						{
							...
							FTimerDelegate TimerDelegate = FTimerDelegate::CreateWeakLambda(
								...
								[this, Done]
								{
									TestGoal(FVector(26.0919f, -36.9541f, 90.0000f), FQuat(-0.4660f, 0.2414f, 0.7558f, 0.3916f));
									TestActorDistance(
										FVector(26.0919f, -36.9541f, 90.0000f), FQuat(-0.4660f, 0.2414f, 0.7558f, 0.3916f), 0.1f, 0.05f);
									Done.Execute();
								});
			...
			LatentIt(
				"should not move actor when movement is disabled",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
			...
			LatentIt(
				"should not move actor when goal is invalid",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]()
