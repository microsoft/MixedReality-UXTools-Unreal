		...
		[this]
		{
			...
			AfterEach(
				[this]
				{
					...
					FrameQueue.Reset();
					auto* TooltipSpawnerComponent = Cast<UUxtTooltipSpawnerComponent>(
						TooltipSpawnerActor->GetComponentByClass(UUxtTooltipSpawnerComponent::StaticClass()));
			...
			LatentIt(
				"Creating/destroying the tooltip spawner",
					...
					FrameQueue.Enqueue(
						[this]
						{
							...
							auto* TooltipSpawnerComponent = Cast<UUxtTooltipSpawnerComponent>(
								TooltipSpawnerActor->GetComponentByClass(UUxtTooltipSpawnerComponent::StaticClass()));
							TestTrue(
								TEXT("The tooltip component should not be null when spawned."),
								TooltipSpawnerComponent->SpawnedTooltip != nullptr);
