...
BEGIN_DEFINE_SPEC(GrabTargetComponentFocusLockSpec, "UXTools.GrabTargetComponent", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
