...
void WidgetComponentSpec::Define()
{
	...
	Describe(
		"Widget Component Poke Interaction",
		[this]
		{
			BeforeEach(
				[this]
	...
	Describe(
		"Widget Component Far Interaction",
		[this]
		{
			BeforeEach(
				[this]
	...
	Describe(
		"Widget Component Two Hand Interaction",
		[this]
		{
			BeforeEach(
				[this]
				{
					...
					Widget = CreateTestComponent(
						"/Game/UXToolsGame/Tests/Widget/BP_TwoInOne.BP_TwoInOne", UxtTestUtils::GetTestWorld(), TargetLocation);
	...
	Describe(
		...
		[this]
		{
			BeforeEach(
				...
				{
					Widget = CreateTestComponent(
						"/Game/UXToolsGame/Tests/Widget/BP_Button.BP_Button", UxtTestUtils::GetTestWorld(), TargetLocation);
			...
			LatentIt(
				"should interact between a UMG button and UXT hands",
	...
	Describe(
		...
		[this]
		{
			BeforeEach(
				...
				{
					Widget = CreateTestComponent(
						"/Game/UXToolsGame/Tests/Widget/BP_Slider.BP_Slider", UxtTestUtils::GetTestWorld(), TargetLocation);
			...
			LatentIt(
				"should interact between a UMG slider and UXT hands",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]
					...
					FrameQueue.Enqueue([this]
									   { TestEqual("New slider value is maximum value", GetWidget<USlider>(Widget)->GetValue(), 1.0f); });
	...
	Describe(
		...
		[this]
		{
			BeforeEach(
				...
				{
					Widget = CreateTestComponent(
						"/Game/UXToolsGame/Tests/Widget/BP_CheckBox.BP_CheckBox", UxtTestUtils::GetTestWorld(), TargetLocation);
			...
			LatentIt(
				"should interact between a UMG check box and UXT hands",
				[this](const FDoneDelegate& Done)
				{
					FrameQueue.Enqueue(
						[this]
...
{
	LatentIt(
		"should interact between UMG widgets and two UXT hands",
		[this](const FDoneDelegate& Done)
		{
			FrameQueue.Enqueue(
				[this]
