...
{
	const int32 NumKeypoints = StaticEnum<EHandKeypoint>()->NumEnums();
	JointOrientation.SetNum(NumKeypoints);
	JointPosition.SetNum(NumKeypoints);
	JointRadius.SetNum(NumKeypoints);
