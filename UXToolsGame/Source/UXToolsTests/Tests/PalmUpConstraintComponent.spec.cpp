...
BEGIN_DEFINE_SPEC(PalmUpConstraintComponentSpec, "UXTools.PalmUpConstraintComponent", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext)
