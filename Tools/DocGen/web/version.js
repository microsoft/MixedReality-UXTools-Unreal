...
{
	// configurable values:
	var defaultTitle = "public/0.9.x"; // title in the dropdown for the root version of the docs - alternatively put a version from the version array as a default
	var versionArray = ["public/0.8.x", "public/0.9.x"]; // list of all versions in the version folder
